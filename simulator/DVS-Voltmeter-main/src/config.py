...
if cfg.SENSOR.CAMERA_TYPE == 'DVS346':
    __C.SENSOR.K = [10.699506617446966, 20, 0.0001, 1e-7, 5e-9, 1e-05]
...
# Directories
__C.DIR                                 = edict()
__C.DIR.IN_PATH = '/tmp/light_source_events_ialh39xm/'
__C.DIR.OUT_PATH = '/tmp/light_source_events_ialh39xm/'
