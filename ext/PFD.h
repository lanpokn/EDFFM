...
const int REX = 640;//Resolution of event camera (width)
const int REY = 480;//Resolution of event camera (height)
...
const std::string event_txt = "E:/2025/event_flick_flare/object_detection/dsec-det-master/data/test/zurich_city_12_a/events/left/events.txt";//input filepath
const std::string path = "E:/2025/event_flick_flare/object_detection/dsec-det-master/data/test/zurich_city_12_a/events/left/";//output path
...
const bool score_seletct = 0;//1 for PFD-A, 0 for PFD-B
